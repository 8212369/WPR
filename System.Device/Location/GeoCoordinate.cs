    ...
    public class GeoCoordinate : IEquatable<GeoCoordinate>
    {
        ...
        public Double Latitude
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("Latitude value must be from -90 to 90!");
                }
                m_latitude = value;
            }
        }
        ...
        public Double Longitude
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("Longtitude value must be from -180 to 180!");
                }
                m_longitude = value;
            }
        }
        ...
        public Double HorizontalAccuracy
        {
            ...
            set
            {
                if (value < 0.0)
                {
                    throw new ArgumentOutOfRangeException("Horizontal accuracy must be non-negative");
                }
        ...
        public Double VerticalAccuracy
        {
            ...
            set
            {
                if (value < 0.0)
                {
                    throw new ArgumentOutOfRangeException("Vertical accuracy must be non-negative");
                }
        ...
        public Double Speed
        {
            ...
            set
            {
                if (value < 0.0)
                {
                    throw new ArgumentOutOfRangeException("Speed must be non-negative");
                }
                m_speed = value;
            }
        }
        ...
        public Double Course
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("Course value must be from 0.0 to 360.0!");
                }
                m_course = value;
            }
        }
        ...
        public Double GetDistanceTo(GeoCoordinate other)
        {
            ...
            {
                throw new ArgumentException("Latitude or longtitude is not a number!");
            }
